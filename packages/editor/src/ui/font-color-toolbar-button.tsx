...
import { buttonVariants } from '@sharebrain/ui/components/button';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
function PureColorPicker({
  ...
  return (
    <div className={cn('flex flex-col', className)} {...props}>
      <ToolbarMenuGroup label={m.editor_colors_custom()}>
        <ColorCustom
          className="px-2"
          color={color}
          colors={colors}
      ...
      <ToolbarMenuGroup label={m.editor_colors_default()}>
    ...
    <div className={cn('flex flex-col gap-4', className)} {...props}>
      ...
      >
        ...
        >
          ...
          >
            <span className="sr-only">{m.editor_colors_custom()}</span>
            <PlusIcon />
          </DropdownMenuItem>
        </ColorInput>
      </ColorDropdownMenuItems>
