...
function CodeBlockCombobox({
  ...
  if (readOnly) {
    ...
    return <CodeBlockLanguageLabel {...(element.lang === undefined ? {} : { lang: element.lang as string | null })} />;
  }
      ...
      >
        <Command shouldFilter={false}>
          <CommandInput
            ...
            placeholder={m.editor_code_search_language()}
          />
...
>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <span className="sr-only">{m.editor_copy()}</span>
      {hasCopied ? (
