    ...
    (event: PointerEvent, finished: boolean) => {
      ...
      const currentWidth = roundCellSizeToStep(
        resizeLengthClampStatic(currentInitial + delta, {
          min: minColumnWidth,
          ...(nextInitial ? { max: complement(minColumnWidth) } : {}),
        }),
        undefined
      );
...
function TableFloatingToolbarContent({
  ...
  return (
    ...
    >
      ...
      >
        <ToolbarGroup>
          <ColorDropdownMenu tooltip={m.editor_font_background()}>
            <PaintBucketIcon />
          </ColorDropdownMenu>
          {canMerge && onMerge && (
            <ToolbarButton
              ...
              tooltip={m.editor_table_merge_cells()}
            >
              <CombineIcon />
            </ToolbarButton>
          )}
          {canSplit && onSplit && (
            <ToolbarButton
              onClick={onSplit}
              onMouseDown={(e) => e.preventDefault()}
              tooltip={m.editor_table_split_cell()}
            >
              <SquareSplitHorizontalIcon />
            </ToolbarButton>
          )}
          ...
          <DropdownMenu modal={false}>
            <DropdownMenuTrigger asChild>
              <ToolbarButton tooltip={m.editor_table_cell_borders()}>
                <Grid2X2Icon />
              </ToolbarButton>
            </DropdownMenuTrigger>
          ...
          {collapsedInside && (
            <ToolbarGroup>
              <ToolbarButton tooltip={m.editor_table_delete()} {...buttonProps}>
                <Trash2Icon />
              </ToolbarButton>
            </ToolbarGroup>
          )}
        ...
        {collapsedInside && (
          <ToolbarGroup>
            <ToolbarButton
              ...
              onMouseDown={(e) => e.preventDefault()}
              tooltip={m.editor_table_insert_row_before()}
            >
              <ArrowUp />
            </ToolbarButton>
            <ToolbarButton
              ...
              onMouseDown={(e) => e.preventDefault()}
              tooltip={m.editor_table_insert_row_after()}
            >
              <ArrowDown />
            </ToolbarButton>
            <ToolbarButton
              onClick={onDeleteRow}
              onMouseDown={(e) => e.preventDefault()}
              tooltip={m.editor_table_delete_row()}
            >
              <XIcon />
            </ToolbarButton>
          </ToolbarGroup>
        ...
        {collapsedInside && (
          <ToolbarGroup>
            <ToolbarButton
              ...
              onMouseDown={(e) => e.preventDefault()}
              tooltip={m.editor_table_insert_col_before()}
            >
              <ArrowLeft />
            </ToolbarButton>
            <ToolbarButton
              ...
              onMouseDown={(e) => e.preventDefault()}
              tooltip={m.editor_table_insert_col_after()}
            >
              <ArrowRight />
            </ToolbarButton>
            <ToolbarButton
              ...
              onMouseDown={(e) => e.preventDefault()}
              tooltip={m.editor_table_delete_col()}
            >
              <XIcon />
            </ToolbarButton>
          </ToolbarGroup>
  ...
  return (
    ...
    >
      <DropdownMenuGroup>
        ...
        >
          <BorderTopIcon />
          <div>{m.editor_table_border_top()}</div>
        </DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem
        ...
        >
          <BorderRightIcon />
          <div>{m.editor_table_border_right()}</div>
        </DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem
        ...
        >
          <BorderBottomIcon />
          <div>{m.editor_table_border_bottom()}</div>
        </DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem
        ...
        >
          <BorderLeftIcon />
          <div>{m.editor_table_border_left()}</div>
        </DropdownMenuCheckboxItem>
      </DropdownMenuGroup>
      ...
      <DropdownMenuGroup>
        ...
        >
          <BorderNoneIcon />
          <div>{m.editor_table_border_none()}</div>
        </DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem
        ...
        >
          <BorderAllIcon />
          <div>{m.editor_table_border_outside()}</div>
        </DropdownMenuCheckboxItem>
      </DropdownMenuGroup>
    </DropdownMenuContent>
  );
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen} modal={false}>
      ...
      <DropdownMenuContent align="start">
        <ToolbarMenuGroup label={m.editor_colors()}>
          <ColorDropdownMenuItems
            className="px-2"
        ...
        <DropdownMenuGroup>
          <DropdownMenuItem className="p-2" onClick={onClearColor}>
            <EraserIcon />
            <span>{m.editor_colors_clear()}</span>
          </DropdownMenuItem>
        </DropdownMenuGroup>
      </DropdownMenuContent>
    </DropdownMenu>
